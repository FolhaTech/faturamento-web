...
-- Tomador (ver calcularNf em engine.ts): NF = fatura + (fatura × gross_up), igual pros dois
-- regimes (padrão 0,1325). O default da COLUNA (só usado se algum INSERT não passar o campo, o
